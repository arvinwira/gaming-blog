export default function KeyHighlights({ highlights }) {
    ...
    return (
        <div className="mt-0 mb-8 glass rounded-2xl px-6 pb-6 pt-2 border-t-4 border-primary shadow-lg">
            <h3 className="text-xl font-bold flex items-center gap-2 mb-3 text-primary" style={{ fontFamily: 'var(--font-heading)' }}>
