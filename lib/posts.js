...
export const CATEGORY_META = {
  // GAMES HUB
  'Game Lists': { icon: '📋', description: 'Discover curated lists of the best games across all genres. From hidden gems to AAA blockbusters, find your next favorite game.', parent: 'games' },
  ...
  'Controllers': { icon: '🎮', description: 'Take control of your games. We find the best gamepads, pro controllers, and fight sticks for PC and console gaming.', parent: 'hardware' },
...
/** Get dynamic count of posts for all categories */
